...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        include 'koneksi.php';
        $no=1;
        $sql = mysqli_query($koneksi, "SELECT * FROM presensi WHERE nama_mahasiswa='$_SESSION[nama_pengguna]' GROUP BY kode_mk, tanggal_presensi ORDER BY tanggal_presensi DESC, waktu_presensi DESC");
while ($data=mysqli_fetch_array($sql)) {
    // print out the values for the kode_mk, nama_mk, tanggal_presensi, waktu_presensi, and data_kehadiran fields
            ?>
                                            <tr>
