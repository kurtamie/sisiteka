...
<head>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      ...
      /* make the container fluid take up the full width of the viewport on small screens */
      .container-fluid {
        width: 100%;
      }

      /* stack the questions and answers vertically on small screens */
      .question {
        display: block;
      }
      ...
      /* make the form take up the full width of the viewport on small screens */
      form.mx-auto.w-50 {
        width: 100%;
      }
    }
