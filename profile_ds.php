...
<?php 
	...
	?>
        ...
        include 'koneksi.php';
        $no=1;
        $sql=mysqli_query($koneksi,"SELECT * FROM dosen where nidn='$_SESSION[id_pengguna]'");
    ...
    <div class="modal fade" id="changepicModal" tabindex="-1" role="dialog" aria-labelledby="changepicModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="ganti_profile_ds.php" method="post" enctype="multipart/form-data">
                <?php
        include 'koneksi.php';
        $no=1;
        $sql=mysqli_query($koneksi,"SELECT * FROM dosen where nidn='$_SESSION[id_pengguna]'");
